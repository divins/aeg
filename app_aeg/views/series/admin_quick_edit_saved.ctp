	...
	<div class="grid_1 omega">
		...
		<?php echo $this->Html->link( $html->image( 'icons/cross.png', array( 'alt' => __( 'Eliminar Serie', true ), 'title' => __( 'Eliminar Serie', true ) ) ), array('action' => 'delete', $this->data['Series']['id']), array( 'escape'=>false ), sprintf(__('Estas segur de voler eliminar: %s?', true), $this->data['Series']['codigo'])); ?>
	</div>