<div Style="text-align:center">
	<div Style="float:left; width:90%; text-align:center; margin-top:12px; font-weight:bold;">
		<?php echo $planols["Part"]["denominacion"]; ?>
	</div>
	<div Style="float:right; text-align:right; min-width:60px; width:10%;">
		<a href="#<?php echo $planols["Part"]["id"];?>" onclick="popup('popUpDiv')"><?php 
	...
	?>
		...
		<?php
		echo $this->Html->link( $this->Html->image($planol["img_digital"], array( "width" => "110", "height" => "80", "alt" => $planol["codigo"], "title" => $planol["codigo"])), "", array('escape'=>false) );
		?>
		<br>
	...
	<?php
		...
		echo $this->Html->image($planols["Planol"][0]["img_digital"], array( "width" => "100%", "height" => "100%", "alt" => $planols["Planol"][0]["codigo"], "title" => $planols["Planol"][0]["codigo"]));
	?>
	</div>
</div>