...
?>	
	...
	<tr>
		...
		?>
			...
			<th class="plan_col"><?php echo __( "Actions", true ); ?></th>
		<?php
		}
		?>
	</tr>
	...
	?>
	<div class="motor_result_row" id="<?php echo "motor_".$motor['Motor']['id']; ?>">
		<div class="motorid_col <?php echo $color_class; ?>"><?php echo $motor['Motor']['id']; ?>&nbsp;</div>
		<div class="piecec_col <?php echo $color_class; ?>"><?php echo $motor['Motor']['clave_pieza']; ?>&nbsp;</div>
		<div class="unityc_col <?php echo $color_class; ?>"><?php echo $motor['Motor']['clave_unidad']; ?>&nbsp;</div>
		<div class="denomination_col <?php echo $color_class; ?>"><?php echo $motor['Motor']['denominacion']; ?>&nbsp;</div>
		<div class="serie_col <?php echo $color_class; ?>"><?php echo $motor['Serie']['codigo']; ?>&nbsp;</div>
		<div class="height_col <?php echo $color_class; ?>"><?php echo $motor['Motor']['altura']; ?>&nbsp;</div>
		<div class="power_col <?php echo $color_class; ?>"><?php echo $motor['Motor']['potencia']; ?>&nbsp;</div>
		<div class="voltage_col <?php echo $color_class; ?>"><?php echo $motor['Motor']['tension']; ?>&nbsp;</div>
		<div class="shape_col <?php echo $color_class; ?>"><?php echo $motor['Motor']['forma']; ?>&nbsp;</div>
		<div class="admin_motors_actions <?php echo $color_class; ?>">
			<?php echo $ajax->link( $html->image( 'icons/picture.png', array( 'alt' => __( 'Show_Plan', true ), 'title' => __( 'Show_Plan', true ) ) ), array( 'controller' => 'motors', 'action' => 'mostrar_planols', $motor['Motor']['id'] ), array( 'escape'=>false, 'update' => 'popUpDiv', 'after' => "popup('popUpDiv')" ) );?>
			<?php echo $ajax->link( $html->image( 'icons/page_edit_mini.png', array( 'alt' => __( 'Quick_Edit', true ), 'title' => __( 'Quick_Edit', true ) ) ), array('action' => 'quick_edit', $motor['Motor']['id'], 0, $color_class ), array( 'escape'=>false, 'update' => 'motor_'.$motor['Motor']['id']) );?>
			<?php echo $this->Html->link( $html->image( 'icons/page_advanced_edit_mini.png', array( 'alt' => __( 'Advanced_Edit', true ), 'title' => __( 'Advanced_Edit', true ) ) ), array('action' => 'edit', $motor['Motor']['id']), array( 'escape'=>false, 'target'=>'_blank' ) ); ?>
			<?php echo $this->Html->link( $html->image( 'icons/cross.png', array( 'alt' => __( 'Delete_Motor', true ), 'title' => __( 'Delete_Motor', true ) ) ), array('action' => 'delete', $motor['Motor']['id']), array( 'escape'=>false), sprintf(__('Do_you_really_wanna_delete_motor?', true), $motor['Motor']['id']) ); ?>
		</div>
	</div>
<?php endforeach; ?>
	</div>
